...
def create_tf_example(image,
  ...
  """
#  image_height = image['height'] if 'height' in image.keys() else 0
#  image_width = image['width'] if 'width' in image.keys() else 0
...
#    logging.info("{}, {}, {}, {}".format(x, y, width, height))
...
#        binary_mask = np.amax(binary_mask, axis=2)
  ...
  if (image_width == 0 or image_height == 0 or (remove_non_person_images and
...
def _create_tf_record_from_coco_annotations(annotations_file, image_dir,
  ...
  with contextlib2.ExitStack() as tf_record_close_stack, \
    ...
    logging.info('Finished writing, skipped %d images.',
                 total_num_images_skipped)
    logging.info('Skipped %d annotations.',
